...
void MenuFunctions::orientDisplay()
{
  ...
  #ifdef HAS_ILI9341
    #ifdef TFT_SHIELD
      uint16_t calData[5] = { 293, 3547, 243, 3592, 3 }; // tft.setRotation(0); // Portrait with TFT Shield
    #else if defined(TFT_DIY)
      uint16_t calData[5] = { 293, 3547, 243, 3592, 3 }; // tft.setRotation(0); // Portrait with DIY TFT
    #endif
